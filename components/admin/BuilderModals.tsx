                ...
                <div className="fixed inset-0 bg-slate-900/50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl flex flex-col overflow-hidden">
                        ...
                        <div className="p-6 grid grid-cols-2 md:grid-cols-4 gap-4 bg-slate-50">
                            ...
                            {/* 💡 새로 추가된 MAP 엘리먼트 버튼 */}
                            <button onClick={() => addElement("MAP")} className="bg-white border border-slate-200 p-4 flex items-center gap-4 hover:border-[#0088cc] hover:shadow-md transition rounded">
                                ...
                                <span className="font-bold text-slate-700">Map</span>
                            </button>
